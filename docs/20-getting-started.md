...
As defined further in the StormPay Open Banking API Specification
...
> The request object used in OIDC flows the aud claim is the issuer url from the StormPay ASPSP .wellknown endpoint (linked below).
